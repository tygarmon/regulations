...
export function StateDetailPanel({ state }: Props) {
  return (
    <div className="space-y-5">
      ...
      {/* SWPPP */}
      <Section title="SWPPP Requirements">
      ...
      {/* Discharge Standards */}
      <Section title="Discharge Standards">
      ...
      {/* Post-Construction */}
      <Section title="Post-Construction">
      ...
      <Section title="Official Resources">
        <div className="space-y-2">
          <a
            href={state.officialLinks.agencyUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-sm text-blue-600 hover:underline"
          >
            {state.agencyAbbr} Website →
          </a>
          <a
          ...
          <a
            href={state.officialLinks.regulationDocUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-sm text-blue-600 hover:underline"
          >
